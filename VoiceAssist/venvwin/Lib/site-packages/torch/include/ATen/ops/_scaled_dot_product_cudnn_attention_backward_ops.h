...
struct TORCH_API _scaled_dot_product_cudnn_attention_backward {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(name, "aten::_scaled_dot_product_cudnn_attention_backward")
