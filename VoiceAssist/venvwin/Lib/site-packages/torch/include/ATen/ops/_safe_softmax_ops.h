...
struct TORCH_API _safe_softmax {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(name, "aten::_safe_softmax")
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(overload_name, "")
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "_safe_softmax(Tensor self, int dim, ScalarType? dtype=None) -> Tensor")
