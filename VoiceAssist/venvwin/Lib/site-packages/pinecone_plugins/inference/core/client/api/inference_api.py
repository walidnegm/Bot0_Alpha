...
from pinecone_plugins.inference.core.client.api_client import (
    ApiClient,
...
class InferenceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __rerank(self, **kwargs):
            """Rerank items  # noqa: E501

            Rerank items according to their relevance to a query.  For guidance and examples, see [Rerank documents](https://docs.pinecone.io/guides/inference/rerank).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
