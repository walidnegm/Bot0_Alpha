...
class RankedDocument(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, index, score, *args, **kwargs):  # noqa: E501
        """RankedDocument - a model defined in OpenAPI

        Args:
            index (int): The index of the document
            score (float): The relevance score of the document normalized between 0 and 1.
    ...
    @convert_js_args_to_python_args
    def __init__(self, index, score, *args, **kwargs):  # noqa: E501
        """RankedDocument - a model defined in OpenAPI
